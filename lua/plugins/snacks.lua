...
--    { "<leader>n", function() Snacks.picker.notifications() end, desc = "Notification History" },
    ...
    { "<leader>ba", function() Snacks.bufdelete.all() end, desc = "Snacks: Delete all buffers" },
    { "<leader>bi", function() Snacks.bufdelete.invisible() end, desc = "Snacks: Delete invisible buffers" },
    -- git
